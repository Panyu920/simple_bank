...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xad\x01\n" +
	"\n" +
	"SimpleBank\x12M\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	":\x01*\"\x05/user\x12P\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/user/loginB?\x92A,\x12*\n" +
	"\vsimple_bank\"\x16\n" +
	"\x14gRPC-Gateway project2\x031.0Z\x0esimple_bank/pbb\x06proto3"
