...
type LoginUserResponse struct {
	...
	Session_Id            string                 `protobuf:"bytes,2,opt,name=session__id,json=sessionId,proto3" json:"session__id,omitempty"`
...
func (x *LoginUserResponse) GetSession_Id() string {
	if x != nil {
		return x.Session_Id
	}
	return ""
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\bpassword\x18\x03 \x01(\tR\bpassword\"\xc1\x02\n" +
	"\x11LoginUserResponse\x12\x1c\n" +
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04user\x12\x1e\n" +
	"\vsession__id\x18\x02 \x01(\tR\tsessionId\x12!\n" +
	"\faccess_token\x18\x03 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x04 \x01(\tR\frefreshToken\x12Q\n" +
	"\x17access_token_expired_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x14accessTokenExpiredAt\x12S\n" +
	"\x18refresh_token_expired_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiredAtB\x10Z\x0esimple_bank/pbb\x06proto3"
